...
// brk is the top of the heap pointer

// brk(void *addr)
//	system call which sets the brk pointer to a given addr
//	returns -1 on error

// sbrk(intptr_t increment)
//	system call to increment brk and return addres of the
//	previous brk, returns (void *)-1 on error
